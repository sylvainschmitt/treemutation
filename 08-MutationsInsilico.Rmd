...
read_tsv("data/mutations/insilico/stats.experiment4.tsv") %>% 
      mutate(type = recode(caller,    
                         "mutect2" = "Cancer variant caller", 
                         "freebayes" = "Generic caller", 
                         "gatk" = "Generic caller", 
                         "strelka2" = "Cancer variant caller",
                         "somaticsniper" = "Cancer variant caller",
                         "muse" = "Cancer variant caller",
                         "varscan" = "Cancer variant caller"
  )) %>% 
    mutate(caller = recode(caller,    
                         "mutect2" = "Mutect2", 
                         "freebayes" = "freebayes", 
