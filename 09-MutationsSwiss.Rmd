...
```{bash, eval=F, echo=T}
n=1000000 # 10^6
samtools view lower_Qrob_Chr01.md.cram -t ~/work/detectMutations/data/bordeaux/Qrob_PM1N.fa | head -n $n | awk '{print $1}' > reads/lower_Qrob_Chr01.reads
samtools view lower_Qrob_Chr02.md.cram -t ~/work/detectMutations/data/bordeaux/Qrob_PM1N.fa | head -n $n | awk '{print $1}' > reads/lower_Qrob_Chr02.reads
samtools view lower_Qrob_Chr03.md.cram -t ~/work/detectMutations/data/bordeaux/Qrob_PM1N.fa | head -n $n | awk '{print $1}' > reads/lower_Qrob_Chr03.reads
samtools view lower_Qrob_Chr04.md.cram -t ~/work/detectMutations/data/bordeaux/Qrob_PM1N.fa | head -n $n | awk '{print $1}' > reads/lower_Qrob_Chr04.reads
```


```{r, fig.height=10, fig.width=10}
ggvenn::ggvenn(list(chr1 = read_tsv("data/mutations/swiss/lower_Qrob_Chr01.reads", col_names = "read")$read,
                    chr2 = read_tsv("data/mutations/swiss/lower_Qrob_Chr02.reads", col_names = "read")$read,
                    chr3 = read_tsv("data/mutations/swiss/lower_Qrob_Chr03.reads", col_names = "read")$read,
                    chr4 = read_tsv("data/mutations/swiss/lower_Qrob_Chr04.reads", col_names = "read")$read), 
               show_percentage = T) +
  ggtitle("Based on the first 10^6 reads aligning on each chromosome")
```
