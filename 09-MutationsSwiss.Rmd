...
strelka_r <- strelka2raw %>% 
  ...
  collect() 
datasets <- list(
  "Schmid-Siegert et al. 2017" = schmid,
  "gatk low" = gatk_l,
  "strelka low" = strelka_l,
  "gatk weak" = gatk_w,
  "strelka weak" = strelka_w,
  "strelka robust" = strelka_r
)
rm(schmid, gatk_l, strelka_l, gatk_w, strelka_w, strelka_r)
```
