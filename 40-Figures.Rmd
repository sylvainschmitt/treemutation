...
cowplot::save_plot(paste0("figs/Fig1.png"), g, dpi = 1000, base_width = 20, base_height = 10, bg = "white")
...
make_plot_af <- function(name = "Angela") {
  ...
  g1 <- ggplot(filter(mutations_hist_log, tree == name),
    ...
    geom_col(aes(fill = "non-transmitted"), col = NA, 
...
gd <- ggplot(data, aes(category, mutation_AF, fill = category)) +
  ...
  theme(legend.position = c(0.5, 0), legend.direction = "horizontal", 
        legend.text = element_text(size = 6), legend.key.size = unit(0.8, "lines"), legend.spacing.y = unit(10, "points"))
```
